...
// Prioritize the database ID from the JSON config as it's updated by the setup tool
const firestoreDatabaseId = (firebaseConfigJson as any).firestoreDatabaseId || getEnv('VITE_FIREBASE_FIRESTORE_DATABASE_ID');
